  ...
  fetch('public/data/data.json')
    ...
    .then((data) => {
      ...
      document.querySelector('#description-1').textContent =
        data.annees[0].description
      document.querySelector('#description-2').textContent =
        data.annees[1].description
      document.querySelector('#description-3').textContent =
        data.annees[2].description
      document.querySelector('#description-4').textContent =
        data.annees[3].description
      document.querySelector('#description-5').textContent =
        data.annees[4].description
    })
